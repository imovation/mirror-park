...
import DormManagement from './panels/DormManagement'
...
export const logisticsPanels: { left: PanelConfig[]; right: PanelConfig[] } = {
  left: [
    { id: 'log-leave', title: '学生请假管理', height: 'flex-2', collapsible: true, collapsedSummary: '今日请假、类型分布、各年级对比、请假记录' },
    { id: 'log-dorm', title: '宿舍管理', height: 'flex-1' },
  ],
  right: [
...
export function renderLogisticsPanel(panelId: string) {
  switch (panelId) {
    ...
    case 'log-dorm': return <DormManagement />
