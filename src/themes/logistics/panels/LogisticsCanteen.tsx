  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 6, flex: 1, minHeight: 0 }}>
      <div style={{ display: 'flex', alignItems: 'stretch', gap: 6, justifyContent: 'center', flexShrink: 0 }}>
        <div style={{ flex: 1, textAlign: 'center', background: 'rgba(0,200,83,0.08)', border: '1px solid var(--border-light)', borderRadius: 6, padding: '6px 8px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        ...
        <div style={{ flex: 1, textAlign: 'center', background: 'rgba(74,158,255,0.08)', border: '1px solid var(--border-light)', borderRadius: 6, padding: '6px 8px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        ...
        <div style={{ flex: 1, textAlign: 'center', background: 'rgba(250,173,20,0.08)', border: '1px solid var(--border-light)', borderRadius: 6, padding: '6px 8px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
      ...
      <div style={{ flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ flex: 1, minHeight: 0, overflow: 'auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 4, alignContent: 'start' }}>
