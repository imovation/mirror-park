...
export default function TeacherTopics() {
  ...
  return (
    <div style={{ display: 'flex', gap: 16, justifyContent: 'center', alignItems: 'center', flex: 1, minHeight: 0 }}>
      ...
      <NumberFlip label="在研课题" value={data.ongoingTopics} unit="项" color="var(--color-warning)" />
    </div>
  )
}
