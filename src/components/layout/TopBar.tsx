  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        <span style={{ fontSize: 'var(--font-size-xl)', fontWeight: 'bold', color: isDark ? '#ffffff' : 'var(--accent)', letterSpacing: 2 }}>
          智慧校园可视化平台
        </span>
      </div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 14, fontSize: 'var(--font-size-md)', color: isDark ? '#ffffff' : 'var(--text-tertiary)' }}>
        <button
        ...
        <button
          ...
          style={{
            ...
            borderRadius: 4,
            color: isDark ? '#ffffff' : (timeMode === 'night' ? '#00e5ff' : '#ffb83c'),
            cursor: 'pointer',
            transition: 'var(--transition-fast)',
            fontSize: 'var(--font-size-sm)',
            fontFamily: 'inherit',
        ...
        <button
          ...
          style={{
            ...
            border: '1px solid ' + (playing ? 'var(--accent)' : 'rgba(255,255,255,0.2)'),
            background: playing ? 'rgba(var(--accent-rgb), 0.2)' : 'rgba(255,255,255,0.08)',
