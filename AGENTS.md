...
**已完成（测试）**：Playwright E2E 测试（76 用例，6 专题 × 38 面板视觉回归截图 + 主题切换/专题导航/建筑交互/告警弹窗/响应式/错误状态/折叠）；Vitest 单元/集成测试 59 用例（stores/api-client/chartTheme/chart-component/ErrorBoundary/ScrollList/3-panel-integration）。
